...
<Tabs>
  <Tab title="Python">
    ...
    | `use_codex_oauth`    | Use ChatGPT Plus/Pro Codex OAuth via Pi auth  | OpenAI            |
    | `codex_auth_file`    | Path to Pi/Codex OAuth auth.json              | OpenAI            |
    | `codex_base_url`     | Base URL for Codex Responses backend          | OpenAI            |
